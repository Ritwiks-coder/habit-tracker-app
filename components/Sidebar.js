...
import {
  ...
  Switch, Animated, Easing, Dimensions, Image, Alert, ScrollView
} from 'react-native';
      ...
      <Animated.View style={[s.sidebar, { transform: [{ translateX: slideAnim }] }]}>
        ...
        >
          ...
          <ToggleRow
            icon={<GhostIcon />}
            title="Ghost Mode"
            subtitle="Keep your progress private"
            value={ghostMode}
          ...
          <ToggleRow
            icon={<SmileIcon />}
            title="Sassy Mode"
            subtitle="Fun & witty task descriptions"
            value={playfulMode}
...
const s = StyleSheet.create({
  ...
  sidebar:        { position: 'absolute', top: 0, left: 0, bottom: 0, width: 331.5, backgroundColor: '#fff', borderTopRightRadius: 28, borderBottomRightRadius: 28, paddingHorizontal: 24, paddingTop: 56, elevation: 9999 },
